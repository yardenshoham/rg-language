...
// posthogScript renders nothing when no key is configured. %q does the quoting, so a
// key or host from the environment cannot break out of the JavaScript string.
